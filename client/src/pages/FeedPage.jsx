...
export default function FeedPage() {
   ...
   * - Activa indicador de carga durante la petición
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Encabezado con título de la aplicación y acción principal */}
      ...
      <main className="max-w-lg mx-auto px-4 py-6 flex flex-col gap-3">
        ...
        {/* Mensaje cuando no hay favores disponibles */}
        ...
        {/* Renderiza cada favor en una tarjeta */}
        {favors.map((favor) => (
          <FavorCard
            key={favor.id}
            favor={favor}
