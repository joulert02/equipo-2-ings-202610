...
export default function FavorCard({ favor, onCancel, onComplete }) {
...
>
     ...
     {favor.requesterId === CURRENT_USER_ID && favor.status === "IN_PROGRESS" && (
<button
         onClick={() => onComplete(favor.id)}
         className="mt-2 w-full text-sm text-emerald-600 border border-emerald-200 rounded-xl py-2 hover:bg-emerald-50 transition-colors"
>
